...
from ls_bart_model import inject_lightseq_layer, LSBartForConditionalGeneration

# Will error if the minimal version of Transformers is not installed. Remove at your own risks.
# The latest version from https://github.com/huggingface/transformers
check_min_version("4.20.0.dev0")

require_version(
    "datasets>=1.8.0",
    "To fix: pip install -r examples/training/huggingface/bart/summarization/requirements.txt",
)
